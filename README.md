...
<요구사항>
[{이름: “윤승록”, MBTI: “INFP”}, …] 의 input과, 한 팀당 최소 팀원 수가 입력되면, 자동으로 팀을 작성하여 화면에 출력해줍니다.
이후 Drag&Drop을 통해, 팀원들의 위치를 조정할 수 있습니다.

<OPTION>
팀별 MBTI 궁합점수를 산정합니다.
궁합점수는 우측 이미지를 기준으로 가산점 계산이 됩니다.
Drag & Drop 시에, 궁합점수도 갱신이 됩니다.
